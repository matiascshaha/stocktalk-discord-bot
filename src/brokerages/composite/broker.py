...
class CompositeTradingBroker:
    ...
    def __init__(self, execution_broker: TradingBrokerPort, quote_provider: MarketDataPort):
    ...
    def place_option_order(self, order: OptionOrder, weighting: Optional[float] = None) -> OrderResult:
        return self._execution_broker.place_option_order(order, weighting=weighting)
