...
| 2026-02-18 | testing | decision | Test architecture is feature-first (`tests/features/<feature>/{happy_path,edge_cases,contracts,smoke}`) with a flat `tests/unit/` class/module suite layout, and shared assets under `tests/testkit/`. | AGENTS.md:64; docs/testing.md:9; tests/README.md:13; tests/TEST_INDEX.md:17 | codex | 2026-05-18 |
